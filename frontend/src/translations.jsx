export const translations = {
    es: {
      ...
      servicios: "Servicios",
      aboutTitle: "Sobre Nosotros",
      aboutText1: "En 3 Devs Solutions, transformamos ideas en software a medida, combinando innovación y tecnología para desarrollar soluciones eficientes y adaptadas a cada cliente.",
      aboutText2: "Nos distingue nuestro compromiso con la excelencia y la satisfacción del cliente. Diseñamos productos de alta calidad mediante metodologías ágiles, optimizando tiempos y garantizando entregas puntuales.",
      aboutText3: "Nuestro equipo está formado por profesionales apasionados, enfocados en ofrecer resultados que marquen la diferencia. Priorizamos la comunicación y la adaptación a cada desafío para garantizar el éxito de cada proyecto.",
      aboutText4: "Entendemos que cada negocio es único. Por eso, iniciamos cada desarrollo con un análisis detallado de tus necesidades y objetivos, aplicando tecnología de vanguardia para superar expectativas.",
    ...
    en: {
      ...
      servicios: "Services",
      aboutTitle: "About Us",
      aboutText1: "At 3 Devs Solutions, we turn ideas into custom software, combining innovation and technology to develop efficient solutions tailored to each client.",
      aboutText2: "We are distinguished by our commitment to excellence and customer satisfaction. We design high-quality products using agile methodologies, optimizing time and ensuring on-time deliveries.",
      aboutText3: "Our team is made up of passionate professionals focused on delivering results that make a difference. We prioritize communication and adaptability to each challenge to ensure project success.",
      aboutText4: "We understand that every business is unique. That's why we start each development with a detailed analysis of your needs and objectives, applying cutting-edge technology to exceed expectations.",
      teamTitle: "Our Team",
  ...
  export const developersData = (language) => [
    {
    ...
    es: [
      {
        ...
        subtitle: "Desarrollo de sitios web modernos, funcionales y optimizados.",
        image: "/img/icono_web.png",
        pros: [
          "Accesible desde cualquier dispositivo con internet.",
          "Fácil mantenimiento y escalabilidad.",
          "No requiere instalación en los dispositivos del usuario.",
      ...
      },
      {
        ...
        subtitle: "Software eficiente y personalizado para entornos de escritorio.",
        image: "/img/icono_escritorio.png",
        pros: [
          "Funciona sin necesidad de conexión a internet.",
          "Mayor rendimiento en tareas exigentes y especializadas.",
          "No depende de servidores externos para su operatividad.",
      ...
      },
      {
        ...
        subtitle: "Aplicaciones para dispositivos móviles adaptadas a tus necesidades.",
        image: "/img/icono_mov.png",
        pros: [
          "Fluidez y optimización para pantallas táctiles.",
          "Mejor uso de los recursos del dispositivo.",
          "Funciona sin conexión en varias tareas.",
    ...
    en: [
      {
        ...
        subtitle: "Development of modern, functional, and optimized websites.",
        image: "/img/icono_web.png",
        pros: [
          "Accessible from any device with internet.",
          "Easy maintenance and scalability.",
      ...
      },
      {
        ...
        subtitle: "Efficient and customized software for desktop environments.",
        image: "/img/icono_escritorio.png",
        pros: [
          "Works without an internet connection.",
          "Better performance for demanding and specialized tasks.",
      ...
      },
      {
        ...
        subtitle: "Mobile applications tailored to your needs.",
        image: "/img/icono_mov.png",
        pros: [
          "Smooth and optimized for touch screens.",
          "Better use of device resources.",
